    ...
    <div className="glass-panel rounded-xl p-5 flex flex-col gap-4">
      <div className="flex items-center justify-between">
        ...
        <div className="text-right">
          ...
          {limit != null && limit > 0 && (
            <span className="text-sm text-slate-500 ml-1">/ {limit.toLocaleString()}</span>
          )}
        </div>
      </div>
      ...
      {pct != null && (
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">{pct}% of plan limit used this month</p>
        </div>
      )}
      ...
      {usage && usage.daily.length > 0 ? (
        ...
        <div className="h-48 flex items-center justify-center text-sm text-slate-500 bg-white/[0.02] rounded-lg">
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400">{month} - activity tracked since you started using PrintFlow POS</p>
        </div>
      </div>
