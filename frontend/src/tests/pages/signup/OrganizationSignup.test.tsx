...
vi.mock('@/hooks/useBilling', () => ({
  useBillingPlans: vi.fn().mockReturnValue({
    data: [
      ...
      { key: 'STARTER', label: 'Starter', priceCents: 3900, popular: false, active: true, stripePriceConfigured: true, limits: { users: 3, ordersPerMonth: 1000, customers: 500, inventoryItems: 2000 }, features: ['3 users'] },
