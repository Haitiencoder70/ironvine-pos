...
const VALID_TRANSITIONS: Partial<Record<OrderStatus, OrderStatus[]>> = {
  ...
  MATERIALS_RECEIVED: ['IN_PRODUCTION', 'CANCELLED', 'ON_HOLD'],
  IN_PRODUCTION: ['QUALITY_CHECK', 'CANCELLED', 'ON_HOLD'],
  QUALITY_CHECK: ['READY_TO_SHIP', 'IN_PRODUCTION', 'CANCELLED', 'ON_HOLD'],
              ...
              ? {
                  requiredMaterials: {
                    create: item.requiredMaterials.map((mat) => ({
                      ...
                      organizationId,
                      attributes: {
                        ...(mat.materialCategory ? { materialCategory: mat.materialCategory } : {}),
                        ...(typeof mat.unitCost === 'number' ? { unitCost: mat.unitCost } : {}),
                      },
                    })),
                  },
                }
