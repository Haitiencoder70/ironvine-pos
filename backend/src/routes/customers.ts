...
import { checkCustomerLimit, checkTrialExpiry } from '../middleware/usage';
import {
  getAll,
  getById,
  create,
...
// ─── Create Customer ──────────────────────────────────────────────────────────
customersRouter.post('/', authorize('customers:create'), checkTrialExpiry, checkCustomerLimit, validate(createCustomerSchema), create);
