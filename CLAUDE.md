...
- Backend Clerk middleware extracts `userId` + `organizationId`
- Prisma middleware auto-filters all queries by `organizationId`
...
- **Auth**: Clerk (free tier, up to 10,000 MAU)
- **Billing**: Stripe (test mode → live mode)
- **Storage**: Supabase Storage (design files)
- **Cost**: ~$0

### Phase 2 — Growth
- Supabase Pro ($25/mo) or Neon Scale
- Vercel Pro
- Clerk Pro
